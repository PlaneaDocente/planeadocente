...
export async function updateSubscriptionByStripeId(
  ...
  if (error) console.error("Error updating subscription by stripe_subscription_id:", error);
}
...
export async function updateSubscriptionBySessionId(
  ...
  if (error) console.error("Error updating subscription by session_id:", error);
}
...
export async function seedDefaultPlans(): Promise<void> {
  ...
  if (existing) return; // Plans already exist
  ...
  if (error) console.error("Error seeding default plans:", error);
  else console.log("✅ Default subscription plans seeded successfully");
}
